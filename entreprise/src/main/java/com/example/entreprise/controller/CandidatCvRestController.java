...
public class CandidatCvRestController {

        @Autowired
        private CandidatCvService candidatCvService;
        @Autowired
        ...
        public ResponseEntity<?> saveCv(@PathVariable Long id, @RequestBody Map<String, Object> payload) {
                try {
                        ...
                        candidatCvService.saveCv(id, personalData, experiences, educations, skills, languages);
